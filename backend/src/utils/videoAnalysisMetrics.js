 ...
 * Keep in sync with frontend/src/features/interviewPrep/utils/videoAnalysisMetrics.js
 *
...
export const aggregateVideoFrameSamples = (samples = [], options = {}) => {
  ...
  for (let i = 0; i < samples.length; i += 1) {
    ...
    // Prefer explicit faceCount when present (including 0 = missing)
  ...
  // Legacy short sparkline timeline for existing report UI
...
export const buildVideoFeedbackText = ({
  eyeContactPercent,
  engagementScore,
  expressionBreakdown,
}) => {
