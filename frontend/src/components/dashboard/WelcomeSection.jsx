  ...
  return (
    <header className="flex flex-col md:flex-row md:items-start justify-between gap-sm min-w-0">
      <div className="min-w-0 flex-1">
        <h1 className="font-headline-dashboard text-headline-dashboard text-on-surface dark:text-[#eaf1ff]">
          {t('welcome.title', { name: welcome.firstName })}
        </h1>
        <p className="font-body-md text-on-surface-variant dark:text-[#94a3b8] mt-base">{t('welcome.subtitle')}</p>
      </div>
