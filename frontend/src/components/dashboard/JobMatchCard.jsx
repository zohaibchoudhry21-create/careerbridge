...
function JobMatchCard({ job }) {
  ...
  return (
    <div className="group p-sm dashboard-inner-surface rounded-2xl border border-transparent hover:border-secondary transition-all cursor-pointer dashboard-card-hover">
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-sm">
        <div className="flex gap-sm min-w-0 flex-1">
          ...
          <div className="min-w-0">
            <h5 className="font-bold text-base break-words text-on-surface">{job.title}</h5>
