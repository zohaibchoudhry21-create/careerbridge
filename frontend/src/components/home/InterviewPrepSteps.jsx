...
export default function InterviewPrepSteps() {
  const { t } = useTranslation('marketing');
  const steps = t('interviewPrepSteps.steps', { returnObjects: true });

  return (
    <section className="bg-surface-container-high py-xl border-y border-outline-variant/20" id="interview-prep">
