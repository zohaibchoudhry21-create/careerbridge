...
export default function NotificationsSettings() {
  ...
  return (
    ...
    >
      ...
      <SectionCard title="Push Notifications" icon="notifications_active" color="settings">
      ...
      <SectionCard title="SMS Notifications" icon="sms" color="settings">
        <ToggleSwitch
          id="sms-security"
      ...
      <SectionCard title="Newsletter" icon="newspaper" color="settings">
        <ToggleSwitch
          id="newsletter"
